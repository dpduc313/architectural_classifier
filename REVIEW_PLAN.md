...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+30,226` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-12,314` patches
  * Quy mô dữ liệu hiện tại sau curation: **`103,903`** patches
