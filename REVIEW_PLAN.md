...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+39,534` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-16,704` patches
  * Quy mô dữ liệu hiện tại sau curation: **`108,821`** patches
