...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+1,375` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-514` patches
  * Quy mô dữ liệu hiện tại sau curation: **`86,852`** patches
