...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+1,295` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-509` patches
  * Quy mô dữ liệu hiện tại sau curation: **`86,777`** patches
