...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+1,093` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-749` patches
  * Quy mô dữ liệu hiện tại sau curation: **`86,335`** patches
