...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+24,926` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-10,631` patches
  * Quy mô dữ liệu hiện tại sau curation: **`100,286`** patches
