...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+31,612` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-12,948` patches
  * Quy mô dữ liệu hiện tại sau curation: **`104,655`** patches
