...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+22,360` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-9,996` patches
  * Quy mô dữ liệu hiện tại sau curation: **`98,355`** patches
