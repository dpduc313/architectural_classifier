...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+42,309` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-17,422` patches
  * Quy mô dữ liệu hiện tại sau curation: **`110,878`** patches
