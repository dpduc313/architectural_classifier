...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+32,917` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-13,632` patches
  * Quy mô dữ liệu hiện tại sau curation: **`105,276`** patches
