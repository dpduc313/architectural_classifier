...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+1,250` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-598` patches
  * Quy mô dữ liệu hiện tại sau curation: **`86,643`** patches
