...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+51,162` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-18,683` patches
  * Quy mô dữ liệu hiện tại sau curation: **`118,470`** patches
