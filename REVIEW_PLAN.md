...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+27,526` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-11,736` patches
  * Quy mô dữ liệu hiện tại sau curation: **`101,781`** patches
