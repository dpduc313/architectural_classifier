...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+1,493` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-404` patches
  * Quy mô dữ liệu hiện tại sau curation: **`87,080`** patches
