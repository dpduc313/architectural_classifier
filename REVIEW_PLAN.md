...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+40,937` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-17,048` patches
  * Quy mô dữ liệu hiện tại sau curation: **`109,880`** patches
