...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+43,694` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-18,071` patches
  * Quy mô dữ liệu hiện tại sau curation: **`111,614`** patches
