...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+38,203` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-16,021` patches
  * Quy mô dữ liệu hiện tại sau curation: **`108,173`** patches
