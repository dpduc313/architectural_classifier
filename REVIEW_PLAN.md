...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+26,202` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-11,226` patches
  * Quy mô dữ liệu hiện tại sau curation: **`100,967`** patches
