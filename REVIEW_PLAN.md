...
* **Kết quả Curated Manifest hiện tại:**
  ...
  * Số patch được bạn thêm lại (YOLO lọc nhầm): `+34,253` patches
  * Số patch được bạn xóa bỏ (vẫn còn nhiễu rác): `-14,227` patches
  * Quy mô dữ liệu hiện tại sau curation: **`106,017`** patches
